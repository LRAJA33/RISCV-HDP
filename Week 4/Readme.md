...
### **Commands**
```
riscv64-unknown-elf-gcc -march=rv32i -mabi=ilp32 -ffreestanding -nostdlib -o out Vending_assemblysimulation_textgen.c
riscv64-unknown-elf-objdump -d  -r out > vending.txt
